...
export interface DatabaseService {
  auth: {
    ...
    changePassword(usuarioId: number, senhaAtual: string, novaSenha: string): Promise<ServiceResult<void>>;
  };
  ...
  categoria: {
    create(categoria: Omit<Categoria, 'id' | 'created_at' | 'updated_at'>): Promise<ServiceResult<Categoria>>;
    ...
    update(id: number, usuarioId: number, updates: Partial<Categoria>): Promise<ServiceResult<boolean>>;
    delete(id: number, usuarioId: number): Promise<ServiceResult<boolean>>;
  };

  orcamento: {
    create(orcamento: Omit<Orcamento, 'id' | 'created_at' | 'updated_at'>): Promise<ServiceResult<Orcamento>>;
    ...
    update(id: number, usuarioId: number, updates: Partial<Orcamento>): Promise<ServiceResult<boolean>>;
    delete(id: number, usuarioId: number): Promise<ServiceResult<boolean>>;
  };
  ...
  parcela: {
    create(parcela: Omit<Parcela, 'id' | 'created_at' | 'updated_at'>): Promise<ServiceResult<Parcela>>;
    ...
    update(id: number, usuarioId: number, updates: Partial<Parcela>): Promise<ServiceResult<boolean>>;
    delete(id: number, usuarioId: number): Promise<ServiceResult<boolean>>;
  };

  transacaoCartao: {
    create(transacao: Omit<TransacaoCartao, 'id' | 'created_at' | 'updated_at'>): Promise<ServiceResult<TransacaoCartao>>;
    createParcelada(
      transacao: Omit<TransacaoCartao, 'id' | 'created_at' | 'updated_at' | 'parcela_atual' | 'grupo_parcelamento'>,
      numeroParcelas: number
    ): Promise<ServiceResult<TransacaoCartao[]>>;
    list(usuarioId: number, cartaoId?: number, mes?: number, ano?: number): Promise<ServiceResult<TransacaoCartaoCompleta[]>>;
    get(id: number, usuarioId: number): Promise<ServiceResult<TransacaoCartao | undefined>>;
    update(id: number, usuarioId: number, updates: Partial<TransacaoCartao>): Promise<ServiceResult<boolean>>;
    delete(id: number, usuarioId: number): Promise<ServiceResult<boolean>>;
  };

  transacao: {
    create(transacao: Omit<Transacao, 'id' | 'created_at' | 'updated_at'>): Promise<ServiceResult<Transacao>>;
    list(usuarioId: number, limit?: number): Promise<ServiceResult<TransacaoCompleta[]>>;
    listPaginated(usuarioId: number, page?: number, pageSize?: number): Promise<ServiceResult<PaginatedResult<TransacaoCompleta>>>;
    get(id: number, usuarioId: number): Promise<ServiceResult<Transacao | undefined>>;
    update(id: number, usuarioId: number, updates: Partial<Transacao>): Promise<ServiceResult<boolean>>;
    delete(id: number, usuarioId: number): Promise<ServiceResult<boolean>>;
  };
  ...
  relatorio: {
    getResumo(usuarioId: number, dataInicio?: string, dataFim?: string): Promise<ServiceResult<ResumoFinanceiro>>;
  };
